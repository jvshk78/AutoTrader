...
#symbols2=['BANKNIFTY18NOVFUT','CRUDEOIL18NOVFUT','GOLDM18NOVFUT','USDINR18NOVFUT','NIFTY18NOVFUT','NIFTY18NOV10100CE','NIFTY18NOV10100PE','BANKNIFTY18NOV24700CE','BANKNIFTY18NOV24700PE']
...
for j in range(len(symbols)):
    ...
    for i in range(len(data)):
        ...
        val[symbols[j]]['vol'].append(data[i][2])
